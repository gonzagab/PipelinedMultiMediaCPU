...
-- Create Date:     07/19/2017 08:58:40 PM
-- Module Name:     alu_4bit_with_cla_tb - testbench
-- Project Name:    pipelined_multimedia_cell_lite_unit
-- Target Devices:  Spartan 7 - xc7s50csga324-1
--
-- Description:
--  This is an exhaustive self checking testbench for a four bit ALU with a Carry
...
entity alu_4bit_with_cla_tb is
end alu_4bit_with_cla_tb;

architecture testbench of alu_4bit_with_cla_tb is
--Input Signals--
...
begin
    ...
    --Unit Under Testing--
    uut: entity xil_defaultlib.alu_4bit_with_cla
        port map (
                --Inputs--
            a      => a,
            b      => b,
